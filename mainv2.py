#Thanks for calc parser gil9red   https://github.com/gil9red
...
#column столбец row строка
	def create_widgets(self):
		...
		self.btn_dot = tkinter.ttk.Button(self, text = "^", command = self.pow)
		self.btn_dot.grid(row = 2, column = 5)
	...
	def result(self):
		text = self.entr.get()
		self.text_in_lbl.set(text+"="+str(Parser(text).calc()))
